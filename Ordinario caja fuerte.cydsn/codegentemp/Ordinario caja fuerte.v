...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  .drive_mode(12'b010_001_001_001),
		  .ibuf_enabled(4'b1_1_1_1),
		  .init_dr_st(4'b1_0_0_0),
		  .input_clk_en(0),
	...
	wire [3:0] tmpOE__Col_net;
	wire [3:0] tmpFB_3__Col_net;
	wire [3:0] tmpIO_3__Col_net;
	wire [0:0] tmpINTERRUPT_0__Col_net;
	...
	cy_psoc3_pins_v1_10
		...
		Col
		 (.oe(tmpOE__Col_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__Col_net[3:0]}),
		  .io({tmpIO_3__Col_net[3:0]}),
		  .siovref(tmpSIOVREF__Col_net),
		  .interrupt({tmpINTERRUPT_0__Col_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Col_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};

	wire [2:0] tmpOE__Led_pins_net;
	wire [2:0] tmpFB_2__Led_pins_net;
	wire [2:0] tmpIO_2__Led_pins_net;
	wire [0:0] tmpINTERRUPT_0__Led_pins_net;
	electrical [0:0] tmpSIOVREF__Led_pins_net;
	...
	cy_psoc3_pins_v1_10
		...
		Led_pins
		 (.oe(tmpOE__Led_pins_net),
		  .y({3'b0}),
		  .fb({tmpFB_2__Led_pins_net[2:0]}),
		  .io({tmpIO_2__Led_pins_net[2:0]}),
		  .siovref(tmpSIOVREF__Led_pins_net),
		  .interrupt({tmpINTERRUPT_0__Led_pins_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Led_pins_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};
